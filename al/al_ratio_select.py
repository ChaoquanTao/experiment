# -*- coding: utf-8 -*-
"""
Created on Wed Nov 13 15:58:32 2019
...
out = open('./data/ratiomae.csv','a', newline='')   
...
for ms in missing_rates:
    ...
    for l in range(length):
        ...
        for ite in range(iteration): #对于每个分配比例重复十次计算误差
            print('\n-----------')
            print('missing rate',ms,"acratio",dict.get(ms).acRatio[l],'rand',dict.get(ms).randRatio[l],"iteration",ite)
            print('-------------\n')
