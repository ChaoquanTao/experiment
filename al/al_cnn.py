# -*- coding: utf-8 -*-
"""
Created on Fri Nov  1 09:32:46 2019
...
out = open('../data/data/alcnnmae2.csv','a', newline='')   
out2 = open('../data/data/alcnntime2.csv','a', newline='')
    ...
    for ite in range(iteration):
        ...
        with tf.Session() as sess:
            ...
            #    batch_xs, batch_ys = mnist.train.next_batch(100)
                ...
                batch_xs = np.array(al_select.active_select(data=mrsrp_sky[offset,:],n=None,mr=ms)).reshape(1,1600)
...
#                print("test")
    ...
    #                MASK = gen_mask2()
                    t = np.array(al_select.active_select(data=t,n=None,mr=mr)).reshape(1,1600)
    #                t = MASK * t
                    test_.append(t)
...
#                plot_image(np.reshape(predict[0],[40,40]))
    ...
    csv_write.writerow(mae/iteration)
    out.flush()
